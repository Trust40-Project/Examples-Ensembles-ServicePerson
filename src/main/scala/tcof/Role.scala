...
class Role[+ComponentType <: Component](val name: String, private[tcof] val parent: WithRoles, private[tcof] val allMembers: RoleMembers[ComponentType], val minCardinality: Int, val maxCardinality: Int) extends WithMembers[ComponentType] with Initializable {
  ...
  override def toString: String =
    s"""Role "$name": ${selectedMembers.mkString(", ")}\n"""
